...
return [
    ...
    'timestamp' => 1603451147,
    'checksum' => 'd55177504cc6859821275f7594e3b8d3',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/xapi' => [
                'file' => 'user/plugins/xapi/blueprints.yaml',
                'modified' => 1603433474
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'plugins.flex-objects.object' => [
                'type' => '_parent',
                'name' => 'plugins.flex-objects.object',
                'form_field' => false
            ],
            'plugins.flex-objects.object.cache' => [
                'type' => '_parent',
                'name' => 'plugins.flex-objects.object.cache',
                'form_field' => false
            ],
            'plugins.flex-objects.object.cache.index' => [
                'type' => '_parent',
                'name' => 'plugins.flex-objects.object.cache.index',
                'form_field' => false
            ],
            'plugins.flex-objects.object.cache.index.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.flex-objects.object.cache.index.enabled',
                'validation' => 'strict'
            ],
            'plugins.flex-objects.object.cache.index.timeout' => [
                'type' => 'text',
                ...
                'name' => 'plugins.flex-objects.object.cache.index.timeout',
                'validation' => 'strict'
            ],
            'plugins.flex-objects.object.cache.object' => [
                'type' => '_parent',
                'name' => 'plugins.flex-objects.object.cache.object',
                'form_field' => false
            ],
            'plugins.flex-objects.object.cache.object.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.flex-objects.object.cache.object.enabled',
                'validation' => 'strict'
            ],
            'plugins.flex-objects.object.cache.object.timeout' => [
                'type' => 'text',
                ...
                'name' => 'plugins.flex-objects.object.cache.object.timeout',
                'validation' => 'strict'
            ],
            'plugins.flex-objects.object.cache.render' => [
                'type' => '_parent',
                'name' => 'plugins.flex-objects.object.cache.render',
                'form_field' => false
            ],
            'plugins.flex-objects.object.cache.render.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.flex-objects.object.cache.render.enabled',
                'validation' => 'strict'
            ],
            'plugins.flex-objects.object.cache.render.timeout' => [
                'type' => 'text',
                ...
                'name' => 'plugins.flex-objects.object.cache.render.timeout',
                'validation' => 'strict'
            ],
            ...
            'plugins.xapi.enabled' => [
                ...
                'name' => 'plugins.xapi.enabled',
                'validation' => 'strict'
            ],
            'plugins.xapi.php' => [
                'type' => '_parent',
                'name' => 'plugins.xapi.php',
                'form_field' => false
            ],
            'plugins.xapi.php.active' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.xapi.php.active',
                'validation' => 'strict'
            ],
            'plugins.xapi.js' => [
                'type' => '_parent',
                'name' => 'plugins.xapi.js',
                'form_field' => false
            ],
            'plugins.xapi.js.active' => [
                'type' => 'toggle',
            ...
            'plugins.xapi.lrs' => [
                ...
                'name' => 'plugins.xapi.lrs',
                'validation' => 'strict'
            ],
            'plugins.xapi.lrs.naming' => [
                'type' => 'text',
                'label' => 'PLUGIN_XAPI.LRS.FIELDS.NAMING',
                'name' => 'plugins.xapi.lrs.naming',
                'validation' => 'strict'
            ],
            'plugins.xapi.lrs.endpoint' => [
                'type' => 'text',
                'label' => 'PLUGIN_XAPI.LRS.FIELDS.ENDPOINT',
                'name' => 'plugins.xapi.lrs.endpoint',
                'validation' => 'strict'
            ],
            'plugins.xapi.lrs.username' => [
                'type' => 'text',
                'label' => 'PLUGIN_XAPI.LRS.FIELDS.USERNAME',
                'name' => 'plugins.xapi.lrs.username',
                'validation' => 'strict'
            ],
            'plugins.xapi.lrs.password' => [
                'type' => 'text',
                'label' => 'PLUGIN_XAPI.LRS.FIELDS.PASSWORD',
                'name' => 'plugins.xapi.lrs.password',
                'validation' => 'strict'
            ],
            'plugins.xapi.lrs.version' => [
                'type' => 'text',
                'label' => 'PLUGIN_XAPI.LRS.FIELDS.VERSION',
                'name' => 'plugins.xapi.lrs.version',
                'validation' => 'strict'
            ],
            'plugins.xapi.template_activityType' => [
                'type' => 'list',
                'style' => 'vertical',
                'label' => 'PLUGIN_XAPI.TEMPLATES.ACTIVITYTYPE.MAIN',
                'name' => 'plugins.xapi.template_activityType',
                'validation' => 'strict'
            ],
            'plugins.xapi.template_activityType.naming' => [
                'type' => 'text',
                'label' => 'PLUGIN_XAPI.TEMPLATES.ACTIVITYTYPE.NAMING',
                'name' => 'plugins.xapi.template_activityType.naming',
                'validation' => 'strict'
            ],
            'plugins.xapi.template_activityType.activityIRI' => [
                'type' => 'text',
                'label' => 'PLUGIN_XAPI.TEMPLATES.ACTIVITYTYPE.IRI',
                'name' => 'plugins.xapi.template_activityType.activityIRI',
                'validation' => 'strict'
            ],
            'plugins.xapi.template_verb' => [
                'type' => 'list',
                'style' => 'vertical',
                'label' => 'PLUGIN_XAPI.TEMPLATES.VERB.MAIN',
                'name' => 'plugins.xapi.template_verb',
                'validation' => 'strict'
            ],
            'plugins.xapi.template_verb.naming' => [
                'type' => 'text',
                'label' => 'PLUGIN_XAPI.TEMPLATES.VERB.NAMING',
                'name' => 'plugins.xapi.template_verb.naming',
                'validation' => 'strict'
            ],
            'plugins.xapi.template_verb.verbIRI' => [
                'type' => 'text',
                'label' => 'PLUGIN_XAPI.TEMPLATES.VERB.IRI',
                'name' => 'plugins.xapi.template_verb.verbIRI',
                'validation' => 'strict'
            ],
            'plugins.xapi.filter' => [
                'type' => 'fieldset',
                ...
                'collapsed' => true,
                'collapsible' => true,
                'name' => 'plugins.xapi.filter',
                'validation' => 'strict'
            ],
            'plugins.xapi.filter.template' => [
                'type' => 'array',
                'label' => 'PLUGIN_XAPI.FILTER.TEMPLATE',
                'value_only' => true,
                'name' => 'plugins.xapi.filter.template',
                'validation' => 'strict'
            ],
            'plugins.xapi.filter.taxonomies' => [
                'type' => 'taxonomy',
                ...
                'name' => 'plugins.xapi.filter.taxonomies',
                'validation' => 'strict'
            ],
            'plugins.xapi.filter.users' => [
                'type' => 'array',
                'label' => 'PLUGIN_XAPI.FILTER.USERS',
                'value_only' => true,
                'name' => 'plugins.xapi.filter.users',
                'validation' => 'strict'
            ],
            'plugins.xapi.filter.groups' => [
                'type' => 'array',
                'label' => 'PLUGIN_XAPI.FILTER.GROUPS',
                'value_only' => true,
                'name' => 'plugins.xapi.filter.groups',
                'validation' => 'strict'
            ],
            'plugins.xapi.filter.uri' => [
                'type' => '_parent',
                'name' => 'plugins.xapi.filter.uri',
                'form_field' => false
            ],
            'plugins.xapi.filter.uri.routes' => [
                'type' => 'array',
                'label' => 'PLUGIN_XAPI.FILTER.URI.ROUTES',
                'value_only' => true,
                'name' => 'plugins.xapi.filter.uri.routes',
                'validation' => 'strict'
            ],
            'plugins.xapi.filter.uri.query' => [
                'type' => 'list',
                'label' => 'PLUGIN_XAPI.FILTER.URI.QUERY',
                'style' => 'horizontal',
                'name' => 'plugins.xapi.filter.uri.query',
                'validation' => 'strict'
            ],
            'plugins.xapi.filter.uri.query.key' => [
                'type' => 'text',
                'label' => 'key',
                'name' => 'plugins.xapi.filter.uri.query.key',
                'validation' => 'strict'
            ],
            'plugins.xapi.filter.uri.query.value' => [
                'type' => 'text',
                'label' => 'value',
                'name' => 'plugins.xapi.filter.uri.query.value',
                'validation' => 'strict'
            ],
            'plugins.xapi.uri' => [
                'type' => 'fieldset',
                'name' => 'plugins.xapi.uri',
                'validation' => 'strict'
            ]
        ],
        'rules' => [
            ...
            'plugins' => [
                ...
                'flex-objects' => [
                    ...
                    'object' => [
                        'cache' => [
                            'index' => [
                                'enabled' => 'plugins.flex-objects.object.cache.index.enabled',
                                'timeout' => 'plugins.flex-objects.object.cache.index.timeout'
                            ],
                            'object' => [
                                'enabled' => 'plugins.flex-objects.object.cache.object.enabled',
                                'timeout' => 'plugins.flex-objects.object.cache.object.timeout'
                            ],
                            'render' => [
                                'enabled' => 'plugins.flex-objects.object.cache.render.enabled',
                                'timeout' => 'plugins.flex-objects.object.cache.render.timeout'
                            ]
                        ]
                    ],
                ...
                'xapi' => [
                    'enabled' => 'plugins.xapi.enabled',
                    'php' => [
                        'active' => 'plugins.xapi.php.active'
                    ],
                    'js' => [
                        'active' => 'plugins.xapi.js.active'
                    ],
                    'lrs' => [
                        'naming' => 'plugins.xapi.lrs.naming',
                        'endpoint' => 'plugins.xapi.lrs.endpoint',
                        'username' => 'plugins.xapi.lrs.username',
                        'password' => 'plugins.xapi.lrs.password',
                        'version' => 'plugins.xapi.lrs.version'
                    ],
                    'template_activityType' => [
                        'naming' => 'plugins.xapi.template_activityType.naming',
                        'activityIRI' => 'plugins.xapi.template_activityType.activityIRI'
                    ],
                    'template_verb' => [
                        'naming' => 'plugins.xapi.template_verb.naming',
                        'verbIRI' => 'plugins.xapi.template_verb.verbIRI'
                    ],
                    'filter' => [
                        'template' => 'plugins.xapi.filter.template',
                        'taxonomies' => 'plugins.xapi.filter.taxonomies',
                        'users' => 'plugins.xapi.filter.users',
                        'groups' => 'plugins.xapi.filter.groups',
                        'uri' => [
                            'routes' => 'plugins.xapi.filter.uri.routes',
                            'query' => [
                                'key' => 'plugins.xapi.filter.uri.query.key',
                                'value' => 'plugins.xapi.filter.uri.query.value'
                            ]
                        ]
                    ],
                    'uri' => 'plugins.xapi.uri'
                ]
            ]
        ],
        'dynamic' => [
